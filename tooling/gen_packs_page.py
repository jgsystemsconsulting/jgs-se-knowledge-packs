...
<!--
  ...
  RR-B-30 browsable skill reference. JGS ink family stylesheet (site.css) plus
  inline page CSS/JS; no third-party asset.
-->
<html lang="en">
<head>
<meta charset="utf-8">
...
<header class="masthead"><div class="wrap">
  ...
  <span>DOC-ID: <b>JGS-SE-KP/REF</b></span>
  <span>REV <b>{ver}</b></span>
</div></header>
...
<footer><div class="wrap">
  <div class="tblock">
    <div><span class="label">Product</span><b>jgs-se-knowledge-packs</b></div>
    <div><span class="label">Rev</span><b>{ver}</b></div>
    <div><span class="label">Licence</span><b>MIT</b></div>
    <div><span class="label">Repository</span><b><a href="{REPO}">github.com/jgsystemsconsulting</a></b></div>
    <div><span class="label">Overview</span><b><a href="index.html">index.html</a></b></div>
    <div><span class="label">Catalogue</span><b><a href="{REPO}/blob/main/SKILLS.md">SKILLS.md</a></b></div>
    <div><span class="label">Usage</span><b><a href="{REPO}/blob/main/docs/skill-usage.md">skill-usage.md</a></b></div>
    <div><span class="label">Owner</span><b>JG Systems Consulting Ltd</b></div>
  </div>
  <p class="foot-note">&copy; 2026 JG Systems Consulting Ltd. MIT Licence. See LICENSE. To request a commercial or academic licence for JGSC Labs products, or if you are unsure which licence you need, use <a href="https://labs.jgsystemsconsulting.com/licensing.html">labs.jgsystemsconsulting.com/licensing.html</a>.</p>
</div></footer>
