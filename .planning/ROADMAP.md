...
Baseline established retroactively (48 packs shipped through v1.16.3, pipeline + install surface validated), then v1.17.0 expands the library with 11 researched candidate packs (8 Tier-1, 3 Tier-2), formal ruled-out tracking, and a synchronized release surface.
...
**Success Criteria** (what must be TRUE):
  ...
  3. Def Stan 00-051 redistribution terms resolved (build-or-exclude decision recorded)
**Plans**: TBD
...
**Goal**: 3 conditional-licence packs built with attribution obligations preserved
**Depends on**: Phase 3
**Requirements**: [T2-01, T2-02, T2-03]
**Success Criteria** (what must be TRUE):
  1. Each pack's LICENSE reproduces source terms; attribution banners present
  2. Packs pass the same validation gates as Tier 1
**Plans**: TBD
...
**Success Criteria** (what must be TRUE):
  1. check_release / CI content-integrity gate passes with 59+ packs
