# Milestone Archive: v1.17.0 — Source Expansion

**Archived:** 2026-08-17 (retroactively; shipped 2026-08-15, tag bcd32af)
**Outcome:** SHIPPED — 8 Tier-1 packs (56 dirs / 54 catalog), ruled-out register established, Phase 4 closed by vetting (IEEE 15288.2 + ECSS excluded, Def Stan 00-051 deferred). Post-tag: doe-o-413-3 rename + catalog alias, capability map regenerated (570 entries), T2 anchors.

## Archived Roadmap (v1.17.0)
