...
| **AFOTEC Test Design Guide** | DTIC serving maintenance shells on citation and PDF endpoints so no in-copy licence check possible; only DTIC hit is the 1989 edition (AD-A205 489), ~37 years stale vs live DAFMAN 63-119 (2021) and DOT&E Enterprise Guidebook (2022); revisit only if AFOTEC publishes a modern public edition (6-RESEARCH.md §1e). (Verified 2026-08-14.) |
| **DoD DAG (Defense Acquisition Guidebook)** | Retired per DAU AAF guidebooks page ("has been retired and replaced"); AFCAPO retirement notice 2022-08-15; dead canonical URLs, Wayback-only text, provenance/versioning risk; AAF guidebooks remain the Tier 1 substitute (6-RESEARCH.md §3a). (Verified 2026-08-14.) |
